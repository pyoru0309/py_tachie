...
function bindControls() {
  ...
  for (const element of [
    ...
    elements.characterBobBpmSource,
    elements.characterBobStyle,
    elements.characterBobHold,
    elements.characterBobRate,
    elements.characterBobOnlyWhileSinging,
    elements.dialogue,
    elements.fontSize,
    elements.fontFamily,
    elements.fontWeight,
  ...
  for (const el of [
    ...
    elements.sceneBpmBobStyle,
    elements.sceneBpmBobHold,
    elements.sceneBpmBobRate,
    elements.sceneBpmBobBpmSource,
    elements.sceneBpmBobOnlyWhileSinging,
